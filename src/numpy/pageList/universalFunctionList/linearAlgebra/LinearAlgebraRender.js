define ([
    ...
    'use strict';
    /**
        * @class LinearAlgebraRender
        * @constructor
    */
    var LinearAlgebraRender = function(numpyOptionObj) {
    ...
    */
    LinearAlgebraRender.prototype = Object.create(NumpyPageRender.prototype);

    /**
     * NumpyPageRender 클래스의 pageRender 메소드 오버라이드
     */
    LinearAlgebraRender.prototype.pageRender = function() {
